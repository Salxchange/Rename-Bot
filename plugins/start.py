...
async def start(client,message):
	...
	reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚚     ɱᴀɪɴ   ᴄʜᴀɴɴᴇʟ     ⚚', url='https://telegram.me/Rokubotz')],[InlineKeyboardButton('👨‍💻   Support', url='https://telegram.me/Team_Roku'),InlineKeyboardButton('📝   ᴀʙᴏᴜᴛ', callback_data = "upgrade")]]))
	    return
	if id:
	    if old == True:
	        try:
